...
app.get("/pj1", function(request, response) {

  response.render("pjPage",{pj:"Joueur 1"});

});

app.get("/pj2", function(request, response) {

  response.render("pjPage",{pj:"Joueur 2"});

});

app.get("/pj3", function(request, response) {

  response.render("pjPage",{pj:"Joueur 3"});

});

app.get("/pj4", function(request, response) {

  response.render("pjPage",{pj:"Joueur 4"});
